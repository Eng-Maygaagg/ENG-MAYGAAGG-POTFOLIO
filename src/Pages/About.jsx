    ...
    return ( 
        <>
           <section className="about_hero flex flex-col md:flex-row justify-center items-center w-full min-h-dvh gap-6 md:gap-5 p-4 sm:p-8 md:p-12 lg:p-20 mt-20 md:mt-10">
                <div className="image_side flex-1 flex justify-center animate__animated animate__fadeInLeft">
                    <img className="rounded w-full max-w-[280px] sm:max-w-[320px] h-auto" src={My_Picture} alt="My Picture" />
                </div>
                <div className="main_txt flex-1 md:flex-2 md:mr-5 w-full max-w-2xl animate__animated animate__fadeInRight animate__delay-0.3s">
                    ...
                    <div className="roles grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6 gap-3 justify-items-center lg:justify-items-start">
                        <div className="card flex flex-col shadow justify-center items-center rounded cursor-pointer w-full max-w-[180px] p-2 animate__animated animate__fadeInUp animate__delay-0.7s">
                        ...
                        <div className="card flex flex-col shadow justify-center items-center rounded cursor-pointer w-full max-w-[180px] p-2 animate__animated animate__fadeInUp animate__delay-0.8s">
                        ...
                        <div className="card flex flex-col shadow justify-center items-center rounded cursor-pointer w-full max-w-[180px] p-2 animate__animated animate__fadeInUp animate__delay-0.9s">
                        ...
                        <div className="card flex flex-col shadow justify-center items-center rounded cursor-pointer w-full max-w-[180px] p-2 animate__animated animate__fadeInUp animate__delay-1s">
                        ...
                        <div className="card flex flex-col shadow justify-center items-center rounded cursor-pointer w-full max-w-[180px] p-2 animate__animated animate__fadeInUp animate__delay-1.1s">
                        ...
                        <div className="card flex flex-col shadow justify-center items-center rounded cursor-pointer w-full max-w-[180px] p-2 animate__animated animate__fadeInUp animate__delay-1.2s">
            ...
            <section className="About_journey_sec flex flex-col justify-center items-center p-4 sm:p-8 md:p-12 lg:p-20">
                <div className="top_part text-center animate__animated animate__fadeInUp">
                ...
                <div className="journey flex flex-col lg:flex-row justify-evenly items-center w-full mt-8 lg:mt-10 gap-6 lg:gap-0 animate__animated animate__fadeInUp animate__delay-0.3s">
                    {/* left_part */}
                    <div className="left_part flex flex-col justify-center items-center lg:items-start gap-4 w-full max-w-[320px]">
                        <div className="card_hide hidden lg:block w-[320px] h-[130px]"></div>
                         <div className="card w-full max-w-[320px] p-4 sm:p-5 items-start flex flex-col justify-center cursor-pointer rounded-xs animate__animated animate__fadeInLeft animate__delay-0.5s">
                    ...
                    <div className="right_part flex flex-col justify-center items-center lg:items-start gap-4 w-full max-w-[320px]">
                        <div className="card w-full max-w-[320px] p-4 sm:p-5 items-start flex flex-col justify-center cursor-pointer rounded-xs animate__animated animate__fadeInRight animate__delay-0.6s">
                            <div className="title flex justify-evenly items-center w-full">
                        ...
                        <div className="card_hide hidden lg:block w-[320px] h-[130px]"></div>
                        <div className="card w-full max-w-[320px] p-4 sm:p-5 items-start flex flex-col justify-center cursor-pointer rounded-xs animate__animated animate__fadeInRight animate__delay-0.7s">
                            <div className="title flex justify-evenly items-center w-full">
            ...
            <section className="About_Focus_Gaol flex flex-col justify-center items-center p-4 sm:p-8 md:p-12 lg:p-20 transition-all">
                <h2 className="font-medium text-lg sm:text-xl mb-4 sm:mb-6 animate__animated animate__fadeInUp">Current Focus & Future Goal</h2>
              <div className="focus_Goal flex flex-col md:flex-row justify-center items-center gap-4 md:gap-5 w-full max-w-4xl animate__animated animate__fadeInUp animate__delay-0.2s">
                  <div className="foces_sec card transition-all hover:border-0 rounded p-4 sm:p-6 flex flex-col justify-center items-center w-full max-w-md animate__animated animate__fadeInLeft animate__delay-0.4s">
                ...
                <div className="gaol_sec card rounded p-4 sm:p-5 transition-all flex flex-col justify-center items-center w-full max-w-md animate__animated animate__fadeInRight animate__delay-0.5s">
