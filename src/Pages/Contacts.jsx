...
function ContactPage() {
    ...
    return ( 
        <>
            <section className="Contacts_sec1 flex flex-col justify-center items-center w-full h-dvh gap-5 p-10 mt-28 relative top-20">
                <h2 className="font-semibold text-2xl mb-5">Contact With Me</h2>

                <div className="Form_Contacts flex justify-evenly items-center w-full h-auto gap-10 p-5">
                <form action="" className="flex flex-col justify-center items-center p-4 w-[400px] h-auto rounded shadow">
                    ...
                    <div className="box flex flex-col justify-center items-start gap-0.5 mb-4">
                        ...
                        <input className="px-2 py-1 border outline-0 rounded w-[300px]" type="text" 
                    ...
                    <div className="box flex flex-col justify-center items-start gap-0.5 mb-4">
                        ...
                        <textarea className="px-2 py-1 border outline-0 rounded w-[300px] h-[120px]" name="massage" placeholder="Write your massage here..." id=""></textarea>
                    </div>                    
                    <button className="px-8 py-4 rounded font-medium text-lg mt-5 w-[300px] cursor-pointer">Submit</button>
                </form>
                <div className="contact_info flex flex-col justify-center items-center w-[400px]">
                    ...
                    <div className="grid grid-cols-2 gap-5 mt-6">
                        ...
                        <div className="card p-3 rounded shadow w-[200px] flex flex-col justify-center items-center h-auto cursor-pointer">
            ...
            <section className="contacts_bottom flex flex-col justify-center items-center w-full h-dvh gap-5 p-10 mb-10 mt-20 relative top-10 transition-all">
                <img src={Contact_img} width="800px" height="200px" alt="" />
                <div className="contact_text_bg absolute w-[600px] h-[190px] blur-xs px-8 py-4 rounded"></div>
                <div className="contact_text absolute w-[600px] h-auto px-8 py-4 rounded shadow flex flex-col justify-center items-center transition-all">
                    <p className="font-medium text-lg text-center mt-2">Hire Me Now</p>
                    <h2 className="font-semibold text-4xl text-center mt-2">I Always Ready To Build A Prevect Software.</h2>
